...
public class YouxiuzhiyuanzheEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public YouxiuzhiyuanzheEntity() {
		
	}
	
	public YouxiuzhiyuanzheEntity(T t) {
		try {
	 ...
	 * 设置：优秀事迹
	 */
	public void setYouxiushiji(String youxiushiji) {
		this.youxiushiji = youxiushiji;
	}
	/**
	 * 获取：优秀事迹
	 */
	public String getYouxiushiji() {
		return youxiushiji;
	}
	/**
	 * 设置：最近点击时间
